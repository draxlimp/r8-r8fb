...
exports.PROTECTION_MODULES = exports.DEFAULT_ALIASES = exports.COMMAND_NAMES = exports.LOG_EVENTS = exports.LOG_CATEGORIES = exports.SYSTEM_LOG_EVENTS = exports.SERVER_LOG_EVENTS = exports.VOICE_LOG_EVENTS = exports.TICKET_LOG_EVENTS = exports.MODERATION_LOG_EVENTS = exports.COMMUNITY_LOG_EVENTS = exports.SECURITY_LOG_EVENTS = void 0;
exports.defaultProtection = defaultProtection;
exports.defaultLogEvent = defaultLogEvent;
exports.defaultMessageAppearance = defaultMessageAppearance;
exports.defaultTicketAppearance = defaultTicketAppearance;
exports.defaultTelloynAppearance = defaultTelloynAppearance;
exports.defaultInstagramAppearance = defaultInstagramAppearance;
exports.defaultRolePanel = defaultRolePanel;
exports.defaultApplicationForm = defaultApplicationForm;
exports.defaultCommandPermission = defaultCommandPermission;
exports.createDefaultGuildConfig = createDefaultGuildConfig;
const emojis_1 = require("../ui/emojis");
exports.SECURITY_LOG_EVENTS = [
...
exports.LOG_CATEGORIES = {
    security: exports.SECURITY_LOG_EVENTS,
    community: exports.COMMUNITY_LOG_EVENTS,
    moderation: exports.MODERATION_LOG_EVENTS,
    tickets: exports.TICKET_LOG_EVENTS,
    voice: exports.VOICE_LOG_EVENTS,
    server: exports.SERVER_LOG_EVENTS,
    system: exports.SYSTEM_LOG_EVENTS
};
exports.LOG_EVENTS = [
    ...exports.SECURITY_LOG_EVENTS,
    ...exports.COMMUNITY_LOG_EVENTS,
...
function defaultProtection(module) {
...
function defaultMessageAppearance(kind) {
    return {
...
function defaultTicketAppearance(kind) {
    return {
...
function defaultTelloynAppearance() {
    return {
        title: 'Telloyn',
...
function defaultInstagramAppearance() {
    return {
        title: 'Instagram',
        description: '',
        color: '#111111',
...
function defaultRolePanel(createdBy = 'system', position = 1) {
...
function defaultApplicationForm(createdBy = 'system', position = 1) {
    const now = new Date().toISOString();
    return {
        id: `FM-${position}`,
...
function defaultCommandPermission() {
...
function createDefaultGuildConfig(guildId) {
    return {
        ...
        commands: {
            aliases: Object.fromEntries(Object.entries(exports.DEFAULT_ALIASES).map(([name, aliases]) => [name, [...aliases]])),
            permissions: Object.fromEntries(exports.COMMAND_NAMES.map(name => [name, defaultCommandPermission()])),
            disabled: []
        },
        moderation: { nextCaseNumber: 1, cases: [], warnings: [], temporaryBans: [] },
        logs: { defaultChannelId: null, events: Object.fromEntries(exports.LOG_EVENTS.map(event => [event, defaultLogEvent()])), lastSentAt: null, failures: [] },
        bypasses: [],
        trustedBots: [],
        protections: Object.fromEntries(exports.PROTECTION_MODULES.map(module => [module, defaultProtection(module)])),
        community: {
            ...
            instagram: {
                ...
                emojis: { like: emojis_1.UI_EMOJIS.heart, comment: emojis_1.UI_EMOJIS.topic, details: emojis_1.UI_EMOJIS.more, delete: emojis_1.UI_EMOJIS.trash },
                posts: {}
            },
            twitter: {
                enabled: false,
